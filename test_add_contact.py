...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, name="natalia", middlename="olegovna", surname="shcherbakova", nick="nick", title="test_title", company="test-company",
                            address="test-address", home="12345", mobile="23456", work="34567", fax="1234567", email="test@mail.ru", email2="test@gmail.ru",
                            email3="test@yandex.ru", homepage="www.test.ru", address2="test address", phone2="test_home", notes="test notes")
    ...
    def create_contact(self, wd, name, middlename, surname, nick, title, company, address, home, mobile, work, fax,
