...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        wd.find_element_by_name("firstname").send_keys("natalia")
        wd.find_element_by_name("middlename").click()
        wd.find_element_by_name("middlename").clear()
        wd.find_element_by_name("middlename").send_keys("olegovna")
        wd.find_element_by_name("lastname").click()
        wd.find_element_by_name("lastname").clear()
        wd.find_element_by_name("lastname").send_keys("shcherbakova")
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys("nick")
        wd.find_element_by_name("photo").click()
        wd.find_element_by_name("photo").clear()
        wd.find_element_by_name("photo").send_keys("C:\\fakepath\\header.jpg")
        ...
        wd.find_element_by_name("mobile").send_keys("23456")
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("34567")
        ...
        wd.find_element_by_name("email2").send_keys("test@gmail.ru")
